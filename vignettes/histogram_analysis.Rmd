...
p50 <- wl_percentile_hist(wl_hist_feb, percentile = 0.50)
cat("Median wait:", round(p50, 1), "weeks\n")

# 95th percentile
p95 <- wl_percentile_hist(wl_hist_feb, percentile = 0.95)
cat("95th percentile wait:", round(p95, 1), "weeks\n")
```
...
patient_data$removal[removal_indices] <- patient_data$referral[removal_indices] + 
  sample(7:60, 30, replace = TRUE)
