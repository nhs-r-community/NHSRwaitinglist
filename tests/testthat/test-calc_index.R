...
wl_test <-
  data.frame(
    ...
    pat_id = c(1L, 2L),
    addition_date = c("2025-03-18",
                      "2025-03-18"),
    removal_date = c("2025-03-20",
                     "2025-03-23"),
    wait_length = c(2.30207068523591,
                    5.40635514242535),
    rott = c(FALSE,FALSE)
    )
...
wl_test2 <-
  data.frame(
    ...
    addition_date = c("2025-03-18",
                      ...
                      "2025-03-19",
                      "2025-03-19"),
    removal_date = c("2025-03-19",
                     "2025-03-19","2025-03-22",
                     "2025-03-23",
                     "2025-03-25"),
    wait_length = c(0.780050907284021,
                    1.04119118489325,
                    2.68020559288561,
                    4.09979836998468,
                    5.61751428212891),
...
wl_test3 <-
  data.frame(
    ...
    addition_date = c("2025-03-19",
                      "2025-03-20","2025-03-20"),
    wait_length = c(0.258584674447775,
                    0.130485113710165,
                    2.40855464339256),
    rott = c(FALSE,FALSE,FALSE)
  )
